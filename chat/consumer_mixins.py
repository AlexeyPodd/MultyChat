...
from chat import cache_manager
...
class ChatMessagingMixin:
    """
    Mixin for Consumer. Responsible for forwarding user messages.
    """
...
class SystemCommandsMixin:
    """
    Mixin for Consumer. Contains system commands.
    """
    ...
    async def _ban_user(self, text_data_json):
        ...
        # getting terms of ban and converting to minutes, or setting None if it is indefinite
        if ban_indefinitely:
            time_end = None
...
class SystemMessagingMixin(SystemCommandsMixin):
    """
    Mixin for Consumer. Responsible for calling system commands, receiving and sending system messages.
    """
